...
CREATE TABLE empleados (
  ...
  FOREIGN KEY (codigo_jefe) REFERENCES empleados (cod_empleado)
)ENGINE=INNODB;

CREATE TABLE gamas_productos (
  gama VARCHAR(50) NOT NULL,
  desc_texto VARCHAR(200),
  desc_html VARCHAR(200),
  imagen VARCHAR(256),
  PRIMARY KEY (gama)
)ENGINE=INNODB;

CREATE TABLE clientes (
  cod_ciente INTEGER NOT NULL,
  ...
  cod_empleado_rep_ventas INTEGER DEFAULT NULL,
  limite_credito NUMERIC(15,2) DEFAULT NULL,
  PRIMARY KEY (cod_ciente),
  FOREIGN KEY (cod_empleado_rep_ventas) REFERENCES empleados (cod_empleado)
)ENGINE=INNODB;
...
CREATE TABLE pedidos (
  ...
  FOREIGN KEY (cod_ciente) REFERENCES clientes (cod_ciente)
)ENGINE=INNODB;
...
CREATE TABLE productos (
  ...
  cant_stock SMALLINT NOT NULL,
  precio_venta NUMERIC(15,2) NOT NULL,
  precio_proveedor NUMERIC(15,2) DEFAULT NULL,
  PRIMARY KEY (cod_producto),
  FOREIGN KEY (gama) REFERENCES gamas_productos (gama)
)ENGINE=INNODB;
...
CREATE TABLE pagos (
  ...
  PRIMARY KEY (cod_ciente, fecha_pago),
  FOREIGN KEY (cod_ciente) REFERENCES clientes (cod_ciente)
)ENGINE=INNODB;
...
INSERT INTO gamas_productos VALUES ('Herbaceas','Plantas para jardin decorativas',NULL,NULL);
INSERT INTO gamas_productos VALUES ('Herramientas','Herramientas para todo tipo de acción',NULL,NULL);
INSERT INTO gamas_productos VALUES ('Aromáticas','Plantas aromáticas',NULL,NULL);
INSERT INTO gamas_productos VALUES ('Frutales','Árboles pequeños de producción frutal',NULL,NULL);
INSERT INTO gamas_productos VALUES ('Ornamentales','Plantas vistosas para la decoración del jardín',NULL,NULL);
...
INSERT INTO pedidos VALUES (8,'2008-11-09','2008-11-14','2008-11-14','Entregado','El clientes paga la mitad con tarjeta y la otra mitad con efectivo, se le realizan dos facturas',1);
INSERT INTO pedidos VALUES (9,'2008-12-22','2008-12-27','2008-12-28','Entregado','El clientes comprueba la integridad del paquete, todo correcto',1);
INSERT INTO pedidos VALUES (10,'2009-01-15','2009-01-20',NULL,'Pendiente','El clientes llama para confirmar la fecha - Esperando al proveedor',3);
INSERT INTO pedidos VALUES (11,'2009-01-20','2009-01-27',NULL,'Pendiente','El clientes requiere que el pedidos se le entregue de 16:00h a 22:00h',1);
INSERT INTO pedidos VALUES (12,'2009-01-22','2009-01-27',NULL,'Pendiente','El clientes requiere que el pedidos se le entregue de 9:00h a 13:00h',1);
INSERT INTO pedidos VALUES (13,'2009-01-12','2009-01-14','2009-01-15','Entregado',NULL,7);
INSERT INTO pedidos VALUES (14,'2009-01-02','2009-01-02',null,'Rechazado','mal pagos',7);
...
INSERT INTO pedidos VALUES (21,'2009-01-09','2009-01-09','2009-01-09','Rechazado','mal pagos',9);
INSERT INTO pedidos VALUES (22,'2009-01-11','2009-01-11','2009-01-13','Entregado',NULL,9);
INSERT INTO pedidos VALUES (23,'2008-12-30','2009-01-10',NULL,'Rechazado','El pedidos fue anulado por el clientes',5);
INSERT INTO pedidos VALUES (24,'2008-07-14','2008-07-31','2008-07-25','Entregado',NULL,14);
INSERT INTO pedidos VALUES (25,'2009-02-02','2009-02-08',NULL,'Rechazado','El clientes carece de saldo en la cuenta asociada',1);
INSERT INTO pedidos VALUES (26,'2009-02-06','2009-02-12',NULL,'Rechazado','El clientes anula la operacion para adquirir mas productos',3);
INSERT INTO pedidos VALUES (27,'2009-02-07','2009-02-13',NULL,'Entregado','El pedidos aparece como entregado pero no sabemos en que fecha',3);
INSERT INTO pedidos VALUES (28,'2009-02-10','2009-02-17','2009-02-20','Entregado','El clientes se queja bastante de la espera asociada al productos',3);
INSERT INTO pedidos VALUES (29,'2008-08-01','2008-09-01','2008-09-01','Rechazado','El clientes no está conforme con el pedidos',14);
INSERT INTO pedidos VALUES (30,'2008-08-03','2008-09-03','2008-08-31','Entregado',NULL,13);
INSERT INTO pedidos VALUES (31,'2008-09-04','2008-09-30','2008-10-04','Rechazado','El clientes ha rechazado por llegar 5 dias tarde',13);
INSERT INTO pedidos VALUES (32,'2007-01-07','2007-01-19','2007-01-27','Entregado','Entrega tardia, el clientes puso reclamacion',4);
INSERT INTO pedidos VALUES (33,'2007-05-20','2007-05-28',NULL,'Rechazado','El pedidos fue anulado por el clientes',4);
...
INSERT INTO pedidos VALUES (37,'2008-11-03','2009-11-13',NULL,'Pendiente','El pedidos nunca llego a su destino',4);
...
INSERT INTO pedidos VALUES (48,'2008-03-17','2008-03-30','2008-03-29','Entregado','Según el Cliente, el pedidos llegó defectuoso',26);
INSERT INTO pedidos VALUES (49,'2008-07-12','2008-07-22','2008-07-30','Entregado','El pedidos llegó 1 día tarde, pero no hubo queja por parte de la empresa compradora',26);
INSERT INTO pedidos VALUES (50,'2008-03-17','2008-08-09',NULL,'Pendiente','Al parecer, el pedidos se ha extraviado a la altura de Sotalbo (Ávila)',26);
...
INSERT INTO pedidos VALUES (52,'2008-12-07','2008-12-21',NULL,'Pendiente','El transportista ha llamado a Eva María para indicarle que el pedidos llegará más tarde de lo esperado.',26);
INSERT INTO pedidos VALUES (53,'2008-10-15','2008-11-15','2008-11-09','Entregado','El pedidos llega 6 dias antes',13);
...
INSERT INTO pedidos VALUES (56,'2008-12-19','2009-01-20',NULL,'Rechazado','El clientes a anulado el pedidos el dia 2009-01-10',13);
...
INSERT INTO pedidos VALUES (59,'2008-11-09','2008-11-14','2008-11-14','Entregado','El clientes paga la mitad con tarjeta y la otra mitad con efectivo, se le realizan dos facturas',1);
INSERT INTO pedidos VALUES (60,'2008-12-22','2008-12-27','2008-12-28','Entregado','El clientes comprueba la integridad del paquete, todo correcto',1);
INSERT INTO pedidos VALUES (61,'2009-01-15','2009-01-20',NULL,'Pendiente','El clientes llama para confirmar la fecha - Esperando al proveedor',3);
INSERT INTO pedidos VALUES (62,'2009-01-20','2009-01-27',NULL,'Pendiente','El clientes requiere que el pedidos se le entregue de 16:00h a 22:00h',1);
INSERT INTO pedidos VALUES (63,'2009-01-22','2009-01-27',NULL,'Pendiente','El clientes requiere que el pedidos se le entregue de 9:00h a 13:00h',1);
INSERT INTO pedidos VALUES (64,'2009-01-24','2009-01-31','2009-01-30','Entregado','Todo correcto',1);
INSERT INTO pedidos VALUES (65,'2009-02-02','2009-02-08',NULL,'Rechazado','El clientes carece de saldo en la cuenta asociada',1);
INSERT INTO pedidos VALUES (66,'2009-02-06','2009-02-12',NULL,'Rechazado','El clientes anula la operacion para adquirir mas productos',3);
INSERT INTO pedidos VALUES (67,'2009-02-07','2009-02-13',NULL,'Entregado','El pedidos aparece como entregado pero no sabemos en que fecha',3);
INSERT INTO pedidos VALUES (68,'2009-02-10','2009-02-17','2009-02-20','Entregado','El clientes se queja bastante de la espera asociada al productos',3);
INSERT INTO pedidos VALUES (74,'2009-01-14','2009-01-22',NULL,'Rechazado','El pedidos no llego el dia que queria el clientes por fallo del transporte',15);
INSERT INTO pedidos VALUES (75,'2009-01-11','2009-01-13','2009-01-13','Entregado','El pedidos llego perfectamente',15);
INSERT INTO pedidos VALUES (76,'2008-11-15','2008-11-23','2008-11-23','Entregado',NULL,15);
INSERT INTO pedidos VALUES (77,'2009-01-03','2009-01-08',NULL,'Pendiente','El pedidos no pudo ser entregado por problemas meteorologicos',15);
...
INSERT INTO pedidos VALUES (80,'2009-01-25','2009-01-26',NULL,'Pendiente','No terminó el pagos',28);
INSERT INTO pedidos VALUES (81,'2009-01-18','2009-01-24',NULL,'Rechazado','Los productos estaban en mal estado',28);
INSERT INTO pedidos VALUES (82,'2009-01-20','2009-01-29','2009-01-29','Entregado','El pedidos llego un poco mas tarde de la hora fijada',28);
INSERT INTO pedidos VALUES (83,'2009-01-24','2009-01-28',NULL,'Entregado',NULL,28);
INSERT INTO pedidos VALUES (89,'2007-10-05','2007-12-13','2007-12-10','Entregado','La entrega se realizo dias antes de la fecha esperada por lo que el clientes quedo satisfecho',35);
INSERT INTO pedidos VALUES (90,'2009-02-07','2008-02-17',NULL,'Pendiente','Debido a la nevada caída en la sierra, el pedidos no podrá llegar hasta el día ',27);
...
INSERT INTO pedidos VALUES (92,'2009-04-19','2009-04-30','2009-05-03','Entregado','El pedidos se entregó tarde debido a la festividad celebrada en España durante esas fechas',27);
INSERT INTO pedidos VALUES (93,'2009-05-03','2009-05-30','2009-05-17','Entregado','El pedidos se entregó antes de lo esperado.',27);
INSERT INTO pedidos VALUES (94,'2009-10-18','2009-11-01',NULL,'Pendiente','El pedidos está en camino.',27);
...
INSERT INTO pedidos VALUES (100,'2009-01-10','2009-01-15','2009-01-15','Entregado','El pedidos llego perfectamente',16);
INSERT INTO pedidos VALUES (101,'2009-03-07','2009-03-27',NULL,'Rechazado','El pedidos fue rechazado por el clientes',16);
...
INSERT INTO pedidos VALUES (105,'2009-02-14','2009-02-20',NULL,'Rechazado','el productos ha sido rechazado por la pesima calidad',30);
...
INSERT INTO pedidos VALUES (113,'2008-10-28','2008-11-09','2009-01-09','Rechazado','El productos ha sido rechazado por la tardanza de el envio',36);
...
INSERT INTO pedidos VALUES (117,'2008-08-25','2008-10-01',NULL,'Rechazado','El pedidos ha sido rechazado por la acumulacion de pagos pendientes del clientes',38);
INSERT INTO pedidos VALUES (118,'2009-02-15','2009-02-27',NULL,'Pendiente',NULL,16);
INSERT INTO pedidos VALUES (119,'2009-01-10','2009-01-15','2009-01-15','Entregado','El pedidos llego perfectamente',16);
INSERT INTO pedidos VALUES (120,'2009-03-07','2009-03-27',NULL,'Rechazado','El pedidos fue rechazado por el clientes',16);
...
INSERT INTO pedidos VALUES (125,'2009-02-14','2009-02-20',NULL,'Rechazado','el productos ha sido rechazado por la pesima calidad',30);
...
INSERT INTO pedidos VALUES (128,'2008-11-10','2008-12-10','2008-12-29','Rechazado','El pedidos ha sido rechazado por el clientes por el retraso en la entrega',38);
...
INSERT INTO productos_pedidos VALUES (1,'FR-67',10,70,3);
INSERT INTO productos_pedidos VALUES (1,'OR-127',40,4,1);
INSERT INTO productos_pedidos VALUES (1,'OR-141',25,4,2);
INSERT INTO productos_pedidos VALUES (1,'OR-241',15,19,4);
INSERT INTO productos_pedidos VALUES (1,'OR-99',23,14,5);
INSERT INTO productos_pedidos VALUES (2,'FR-4',3,29,6);
INSERT INTO productos_pedidos VALUES (2,'FR-40',7,8,7);
INSERT INTO productos_pedidos VALUES (2,'OR-140',50,4,3);
INSERT INTO productos_pedidos VALUES (2,'OR-141',20,5,2);
INSERT INTO productos_pedidos VALUES (2,'OR-159',12,6,5);
INSERT INTO productos_pedidos VALUES (2,'OR-227',67,64,1);
INSERT INTO productos_pedidos VALUES (2,'OR-247',5,462,4);
INSERT INTO productos_pedidos VALUES (3,'FR-48',120,9,6);
INSERT INTO productos_pedidos VALUES (3,'OR-122',32,5,4);
INSERT INTO productos_pedidos VALUES (3,'OR-123',11,5,5);
INSERT INTO productos_pedidos VALUES (3,'OR-213',30,266,1);
INSERT INTO productos_pedidos VALUES (3,'OR-217',15,65,2);
INSERT INTO productos_pedidos VALUES (3,'OR-218',24,25,3);
INSERT INTO productos_pedidos VALUES (4,'FR-31',12,8,7);
INSERT INTO productos_pedidos VALUES (4,'FR-34',42,8,6);
INSERT INTO productos_pedidos VALUES (4,'FR-40',42,9,8);
INSERT INTO productos_pedidos VALUES (4,'OR-152',3,6,5);
INSERT INTO productos_pedidos VALUES (4,'OR-155',4,6,3);
INSERT INTO productos_pedidos VALUES (4,'OR-156',17,9,4);
INSERT INTO productos_pedidos VALUES (4,'OR-157',38,10,2);
INSERT INTO productos_pedidos VALUES (4,'OR-222',21,59,1);
INSERT INTO productos_pedidos VALUES (8,'FR-106',3,11,1);
INSERT INTO productos_pedidos VALUES (8,'FR-108',1,32,2);
INSERT INTO productos_pedidos VALUES (8,'FR-11',10,100,3);
INSERT INTO productos_pedidos VALUES (9,'AR-001',80,1,3);
INSERT INTO productos_pedidos VALUES (9,'AR-008',450,1,2);
INSERT INTO productos_pedidos VALUES (9,'FR-106',80,8,1);
INSERT INTO productos_pedidos VALUES (9,'FR-69',15,91,2);
INSERT INTO productos_pedidos VALUES (10,'FR-82',5,70,2);
INSERT INTO productos_pedidos VALUES (10,'FR-91',30,75,1);
INSERT INTO productos_pedidos VALUES (10,'OR-234',5,64,3);
INSERT INTO productos_pedidos VALUES (11,'AR-006',180,1,3);
INSERT INTO productos_pedidos VALUES (11,'OR-247',80,8,1);
INSERT INTO productos_pedidos VALUES (12,'AR-009',290,1,1);
INSERT INTO productos_pedidos VALUES (13,'11679',5,14,1);
INSERT INTO productos_pedidos VALUES (13,'21636',12,14,2);
INSERT INTO productos_pedidos VALUES (13,'FR-11',5,100,3);
INSERT INTO productos_pedidos VALUES (14,'FR-100',8,11,2);
INSERT INTO productos_pedidos VALUES (14,'FR-13',13,57,1);
INSERT INTO productos_pedidos VALUES (15,'FR-84',4,13,3);
INSERT INTO productos_pedidos VALUES (15,'OR-101',2,6,2);
INSERT INTO productos_pedidos VALUES (15,'OR-156',6,10,1);
INSERT INTO productos_pedidos VALUES (15,'OR-203',9,10,4);
INSERT INTO productos_pedidos VALUES (16,'30310',12,12,1);
INSERT INTO productos_pedidos VALUES (16,'FR-36',10,9,2);
INSERT INTO productos_pedidos VALUES (17,'11679',5,14,1);
INSERT INTO productos_pedidos VALUES (17,'22225',5,12,3);
INSERT INTO productos_pedidos VALUES (17,'FR-37',5,9,2);
INSERT INTO productos_pedidos VALUES (17,'FR-64',5,22,4);
INSERT INTO productos_pedidos VALUES (17,'OR-136',5,18,5);
INSERT INTO productos_pedidos VALUES (18,'22225',4,12,2);
INSERT INTO productos_pedidos VALUES (18,'FR-22',2,4,1);
INSERT INTO productos_pedidos VALUES (18,'OR-159',10,6,3);
INSERT INTO productos_pedidos VALUES (19,'30310',9,12,5);
INSERT INTO productos_pedidos VALUES (19,'FR-23',6,8,4);
INSERT INTO productos_pedidos VALUES (19,'FR-75',1,32,2);
INSERT INTO productos_pedidos VALUES (19,'FR-84',5,13,1);
INSERT INTO productos_pedidos VALUES (19,'OR-208',20,4,3);
INSERT INTO productos_pedidos VALUES (20,'11679',14,14,1);
INSERT INTO productos_pedidos VALUES (20,'30310',8,12,2);
INSERT INTO productos_pedidos VALUES (21,'21636',5,14,3);
INSERT INTO productos_pedidos VALUES (21,'FR-18',22,4,1);
INSERT INTO productos_pedidos VALUES (21,'FR-53',3,8,2);
INSERT INTO productos_pedidos VALUES (22,'OR-240',1,6,1);
INSERT INTO productos_pedidos VALUES (23,'AR-002',110,1,4);
INSERT INTO productos_pedidos VALUES (23,'FR-107',50,22,3);
INSERT INTO productos_pedidos VALUES (23,'FR-85',4,70,2);
INSERT INTO productos_pedidos VALUES (23,'OR-249',30,5,1);
INSERT INTO productos_pedidos VALUES (24,'22225',3,15,1);
INSERT INTO productos_pedidos VALUES (24,'FR-1',4,7,4);
INSERT INTO productos_pedidos VALUES (24,'FR-23',2,7,2);
INSERT INTO productos_pedidos VALUES (24,'OR-241',10,20,3);
INSERT INTO productos_pedidos VALUES (25,'FR-77',15,69,1);
INSERT INTO productos_pedidos VALUES (25,'FR-9',4,30,3);
INSERT INTO productos_pedidos VALUES (25,'FR-94',10,30,2);
INSERT INTO productos_pedidos VALUES (26,'FR-15',9,25,3);
INSERT INTO productos_pedidos VALUES (26,'OR-188',4,25,1);
INSERT INTO productos_pedidos VALUES (26,'OR-218',14,25,2);
INSERT INTO productos_pedidos VALUES (27,'OR-101',22,6,2);
INSERT INTO productos_pedidos VALUES (27,'OR-102',22,6,3);
INSERT INTO productos_pedidos VALUES (27,'OR-186',40,6,1);
INSERT INTO productos_pedidos VALUES (28,'FR-11',8,99,3);
INSERT INTO productos_pedidos VALUES (28,'OR-213',3,266,2);
INSERT INTO productos_pedidos VALUES (28,'OR-247',1,462,1);
INSERT INTO productos_pedidos VALUES (29,'FR-82',4,70,4);
INSERT INTO productos_pedidos VALUES (29,'FR-9',4,28,1);
INSERT INTO productos_pedidos VALUES (29,'FR-94',20,31,5);
INSERT INTO productos_pedidos VALUES (29,'OR-129',2,111,2);
INSERT INTO productos_pedidos VALUES (29,'OR-160',10,9,3);
INSERT INTO productos_pedidos VALUES (30,'AR-004',10,1,6);
INSERT INTO productos_pedidos VALUES (30,'FR-108',2,32,2);
INSERT INTO productos_pedidos VALUES (30,'FR-12',2,19,3);
INSERT INTO productos_pedidos VALUES (30,'FR-72',4,31,5);
INSERT INTO productos_pedidos VALUES (30,'FR-89',10,45,1);
INSERT INTO productos_pedidos VALUES (30,'OR-120',5,5,4);
INSERT INTO productos_pedidos VALUES (31,'AR-009',25,2,3);
INSERT INTO productos_pedidos VALUES (31,'FR-102',1,20,1);
INSERT INTO productos_pedidos VALUES (31,'FR-4',6,29,2);
INSERT INTO productos_pedidos VALUES (32,'11679',1,14,4);
INSERT INTO productos_pedidos VALUES (32,'21636',4,15,5);
INSERT INTO productos_pedidos VALUES (32,'22225',1,15,3);
INSERT INTO productos_pedidos VALUES (32,'OR-128',29,100,2);
INSERT INTO productos_pedidos VALUES (32,'OR-193',5,20,1);
INSERT INTO productos_pedidos VALUES (33,'FR-17',423,2,4);
INSERT INTO productos_pedidos VALUES (33,'FR-29',120,8,3);
INSERT INTO productos_pedidos VALUES (33,'OR-214',212,10,2);
INSERT INTO productos_pedidos VALUES (33,'OR-247',150,462,1);
INSERT INTO productos_pedidos VALUES (34,'FR-3',56,7,4);
INSERT INTO productos_pedidos VALUES (34,'FR-7',12,29,3);
INSERT INTO productos_pedidos VALUES (34,'OR-172',20,18,1);
INSERT INTO productos_pedidos VALUES (34,'OR-174',24,18,2);
INSERT INTO productos_pedidos VALUES (35,'21636',12,14,4);
INSERT INTO productos_pedidos VALUES (35,'FR-47',55,8,3);
INSERT INTO productos_pedidos VALUES (35,'OR-165',3,10,2);
INSERT INTO productos_pedidos VALUES (35,'OR-181',36,10,1);
INSERT INTO productos_pedidos VALUES (35,'OR-225',72,10,5);
INSERT INTO productos_pedidos VALUES (36,'30310',4,12,2);
INSERT INTO productos_pedidos VALUES (36,'FR-1',2,7,3);
INSERT INTO productos_pedidos VALUES (36,'OR-147',6,7,4);
INSERT INTO productos_pedidos VALUES (36,'OR-203',1,12,5);
INSERT INTO productos_pedidos VALUES (36,'OR-99',15,13,1);
INSERT INTO productos_pedidos VALUES (37,'FR-105',4,70,1);
INSERT INTO productos_pedidos VALUES (37,'FR-57',203,8,2);
INSERT INTO productos_pedidos VALUES (37,'OR-176',38,10,3);
INSERT INTO productos_pedidos VALUES (38,'11679',5,14,1);
INSERT INTO productos_pedidos VALUES (38,'21636',2,14,2);
INSERT INTO productos_pedidos VALUES (39,'22225',3,12,1);
INSERT INTO productos_pedidos VALUES (39,'30310',6,12,2);
INSERT INTO productos_pedidos VALUES (40,'AR-001',4,1,1);
INSERT INTO productos_pedidos VALUES (40,'AR-002',8,1,2);
INSERT INTO productos_pedidos VALUES (41,'AR-003',5,1,1);
INSERT INTO productos_pedidos VALUES (41,'AR-004',5,1,2);
INSERT INTO productos_pedidos VALUES (42,'AR-005',3,1,1);
INSERT INTO productos_pedidos VALUES (42,'AR-006',1,1,2);
INSERT INTO productos_pedidos VALUES (43,'AR-007',9,1,1);
INSERT INTO productos_pedidos VALUES (44,'AR-008',5,1,1);
INSERT INTO productos_pedidos VALUES (45,'AR-009',6,1,1);
INSERT INTO productos_pedidos VALUES (45,'AR-010',4,1,2);
INSERT INTO productos_pedidos VALUES (46,'FR-1',4,7,1);
INSERT INTO productos_pedidos VALUES (46,'FR-10',8,7,2);
INSERT INTO productos_pedidos VALUES (47,'FR-100',9,11,1);
INSERT INTO productos_pedidos VALUES (47,'FR-101',5,13,2);
INSERT INTO productos_pedidos VALUES (48,'FR-102',1,18,1);
INSERT INTO productos_pedidos VALUES (48,'FR-103',1,25,2);
INSERT INTO productos_pedidos VALUES (48,'OR-234',50,64,1);
INSERT INTO productos_pedidos VALUES (48,'OR-236',45,49,2);
INSERT INTO productos_pedidos VALUES (48,'OR-237',50,19,3);
INSERT INTO productos_pedidos VALUES (49,'OR-204',50,10,1);
INSERT INTO productos_pedidos VALUES (49,'OR-205',10,10,2);
INSERT INTO productos_pedidos VALUES (49,'OR-206',5,5,3);
INSERT INTO productos_pedidos VALUES (50,'OR-225',12,10,1);
INSERT INTO productos_pedidos VALUES (50,'OR-226',15,38,2);
INSERT INTO productos_pedidos VALUES (50,'OR-227',44,64,3);
INSERT INTO productos_pedidos VALUES (51,'OR-209',50,10,1);
INSERT INTO productos_pedidos VALUES (51,'OR-210',80,39,2);
INSERT INTO productos_pedidos VALUES (51,'OR-211',70,59,3);
INSERT INTO productos_pedidos VALUES (53,'FR-2',1,7,1);
INSERT INTO productos_pedidos VALUES (53,'FR-85',1,70,3);
INSERT INTO productos_pedidos VALUES (53,'FR-86',2,11,2);
INSERT INTO productos_pedidos VALUES (53,'OR-116',6,7,4);
INSERT INTO productos_pedidos VALUES (54,'11679',3,14,3);
INSERT INTO productos_pedidos VALUES (54,'FR-100',45,10,2);
INSERT INTO productos_pedidos VALUES (54,'FR-18',5,4,1);
INSERT INTO productos_pedidos VALUES (54,'FR-79',3,22,4);
INSERT INTO productos_pedidos VALUES (54,'OR-116',8,7,6);
INSERT INTO productos_pedidos VALUES (54,'OR-123',3,5,5);
INSERT INTO productos_pedidos VALUES (54,'OR-168',2,10,7);
INSERT INTO productos_pedidos VALUES (55,'OR-115',9,7,1);
INSERT INTO productos_pedidos VALUES (55,'OR-213',2,266,2);
INSERT INTO productos_pedidos VALUES (55,'OR-227',6,64,5);
INSERT INTO productos_pedidos VALUES (55,'OR-243',2,64,4);
INSERT INTO productos_pedidos VALUES (55,'OR-247',1,462,3);
INSERT INTO productos_pedidos VALUES (56,'OR-129',1,115,5);
INSERT INTO productos_pedidos VALUES (56,'OR-130',10,18,6);
INSERT INTO productos_pedidos VALUES (56,'OR-179',1,6,3);
INSERT INTO productos_pedidos VALUES (56,'OR-196',3,10,4);
INSERT INTO productos_pedidos VALUES (56,'OR-207',4,4,2);
INSERT INTO productos_pedidos VALUES (56,'OR-250',3,10,1);
INSERT INTO productos_pedidos VALUES (57,'FR-69',6,91,4);
INSERT INTO productos_pedidos VALUES (57,'FR-81',3,49,3);
INSERT INTO productos_pedidos VALUES (57,'FR-84',2,13,1);
INSERT INTO productos_pedidos VALUES (57,'FR-94',6,9,2);
INSERT INTO productos_pedidos VALUES (58,'OR-102',65,18,3);
INSERT INTO productos_pedidos VALUES (58,'OR-139',80,4,1);
INSERT INTO productos_pedidos VALUES (58,'OR-172',69,15,2);
INSERT INTO productos_pedidos VALUES (58,'OR-177',150,15,4);
INSERT INTO productos_pedidos VALUES (74,'FR-67',15,70,1);
INSERT INTO productos_pedidos VALUES (74,'OR-227',34,64,2);
INSERT INTO productos_pedidos VALUES (74,'OR-247',42,8,3);
INSERT INTO productos_pedidos VALUES (75,'AR-006',60,1,2);
INSERT INTO productos_pedidos VALUES (75,'FR-87',24,22,3);
INSERT INTO productos_pedidos VALUES (75,'OR-157',46,10,1);
INSERT INTO productos_pedidos VALUES (76,'AR-009',250,1,5);
INSERT INTO productos_pedidos VALUES (76,'FR-79',40,22,3);
INSERT INTO productos_pedidos VALUES (76,'FR-87',24,22,4);
INSERT INTO productos_pedidos VALUES (76,'FR-94',35,9,1);
INSERT INTO productos_pedidos VALUES (76,'OR-196',25,10,2);
INSERT INTO productos_pedidos VALUES (77,'22225',34,12,2);
INSERT INTO productos_pedidos VALUES (77,'30310',15,12,1);
INSERT INTO productos_pedidos VALUES (78,'FR-53',25,8,2);
INSERT INTO productos_pedidos VALUES (78,'FR-85',56,70,3);
INSERT INTO productos_pedidos VALUES (78,'OR-157',42,10,4);
INSERT INTO productos_pedidos VALUES (78,'OR-208',30,4,1);
INSERT INTO productos_pedidos VALUES (79,'OR-240',50,6,1);
INSERT INTO productos_pedidos VALUES (80,'FR-11',40,100,3);
INSERT INTO productos_pedidos VALUES (80,'FR-36',47,9,2);
INSERT INTO productos_pedidos VALUES (80,'OR-136',75,18,1);
INSERT INTO productos_pedidos VALUES (81,'OR-208',30,4,1);
INSERT INTO productos_pedidos VALUES (82,'OR-227',34,64,1);
INSERT INTO productos_pedidos VALUES (83,'OR-208',30,4,1);
INSERT INTO productos_pedidos VALUES (89,'FR-108',3,32,2);
INSERT INTO productos_pedidos VALUES (89,'FR-3',15,7,6);
INSERT INTO productos_pedidos VALUES (89,'FR-42',12,8,4);
INSERT INTO productos_pedidos VALUES (89,'FR-66',5,49,1);
INSERT INTO productos_pedidos VALUES (89,'FR-87',4,22,3);
INSERT INTO productos_pedidos VALUES (89,'OR-157',8,10,5);
INSERT INTO productos_pedidos VALUES (90,'AR-001',19,1,1);
INSERT INTO productos_pedidos VALUES (90,'AR-002',10,1,2);
INSERT INTO productos_pedidos VALUES (90,'AR-003',12,1,3);
INSERT INTO productos_pedidos VALUES (91,'FR-100',52,11,1);
INSERT INTO productos_pedidos VALUES (91,'FR-101',14,13,2);
INSERT INTO productos_pedidos VALUES (91,'FR-102',35,18,3);
INSERT INTO productos_pedidos VALUES (92,'FR-108',12,23,1);
INSERT INTO productos_pedidos VALUES (92,'FR-11',20,100,2);
INSERT INTO productos_pedidos VALUES (92,'FR-12',30,21,3);
INSERT INTO productos_pedidos VALUES (93,'FR-54',25,9,1);
INSERT INTO productos_pedidos VALUES (93,'FR-58',51,11,2);
INSERT INTO productos_pedidos VALUES (93,'FR-60',3,32,3);
INSERT INTO productos_pedidos VALUES (94,'11679',12,14,1);
INSERT INTO productos_pedidos VALUES (94,'FR-11',33,100,3);
INSERT INTO productos_pedidos VALUES (94,'FR-4',79,29,2);
INSERT INTO productos_pedidos VALUES (95,'FR-10',9,7,2);
INSERT INTO productos_pedidos VALUES (95,'FR-75',6,32,1);
INSERT INTO productos_pedidos VALUES (95,'FR-82',5,70,3);
INSERT INTO productos_pedidos VALUES (96,'FR-43',6,8,1);
INSERT INTO productos_pedidos VALUES (96,'FR-6',16,7,4);
INSERT INTO productos_pedidos VALUES (96,'FR-71',10,22,3);
INSERT INTO productos_pedidos VALUES (96,'FR-90',4,70,2);
INSERT INTO productos_pedidos VALUES (97,'FR-41',12,8,1);
INSERT INTO productos_pedidos VALUES (97,'FR-54',14,9,2);
INSERT INTO productos_pedidos VALUES (97,'OR-156',10,10,3);
INSERT INTO productos_pedidos VALUES (98,'FR-33',14,8,4);
INSERT INTO productos_pedidos VALUES (98,'FR-56',16,8,3);
INSERT INTO productos_pedidos VALUES (98,'FR-60',8,32,1);
INSERT INTO productos_pedidos VALUES (98,'FR-8',18,6,5);
INSERT INTO productos_pedidos VALUES (98,'FR-85',6,70,2);
INSERT INTO productos_pedidos VALUES (99,'OR-157',15,10,2);
INSERT INTO productos_pedidos VALUES (99,'OR-227',30,64,1);
INSERT INTO productos_pedidos VALUES (100,'FR-87',20,22,1);
INSERT INTO productos_pedidos VALUES (100,'FR-94',40,9,2);
INSERT INTO productos_pedidos VALUES (101,'AR-006',50,1,1);
INSERT INTO productos_pedidos VALUES (101,'AR-009',159,1,2);
INSERT INTO productos_pedidos VALUES (102,'22225',32,12,2);
INSERT INTO productos_pedidos VALUES (102,'30310',23,12,1);
INSERT INTO productos_pedidos VALUES (103,'FR-53',12,8,2);
INSERT INTO productos_pedidos VALUES (103,'OR-208',52,4,1);
INSERT INTO productos_pedidos VALUES (104,'FR-85',9,70,1);
INSERT INTO productos_pedidos VALUES (104,'OR-157',113,10,2);
INSERT INTO productos_pedidos VALUES (105,'OR-227',21,64,2);
INSERT INTO productos_pedidos VALUES (105,'OR-240',27,6,1);
INSERT INTO productos_pedidos VALUES (106,'AR-009',231,1,1);
INSERT INTO productos_pedidos VALUES (106,'OR-136',47,18,2);
INSERT INTO productos_pedidos VALUES (107,'30310',143,12,2);
INSERT INTO productos_pedidos VALUES (107,'FR-11',15,100,1);
INSERT INTO productos_pedidos VALUES (108,'FR-53',53,8,1);
INSERT INTO productos_pedidos VALUES (108,'OR-208',59,4,2);
INSERT INTO productos_pedidos VALUES (109,'FR-22',8,4,5);
INSERT INTO productos_pedidos VALUES (109,'FR-36',12,9,3);
INSERT INTO productos_pedidos VALUES (109,'FR-45',14,8,4);
INSERT INTO productos_pedidos VALUES (109,'OR-104',20,10,1);
INSERT INTO productos_pedidos VALUES (109,'OR-119',10,5,2);
INSERT INTO productos_pedidos VALUES (109,'OR-125',3,5,6);
INSERT INTO productos_pedidos VALUES (109,'OR-130',2,18,7);
INSERT INTO productos_pedidos VALUES (110,'AR-010',6,1,3);
INSERT INTO productos_pedidos VALUES (110,'FR-1',14,7,1);
INSERT INTO productos_pedidos VALUES (110,'FR-16',1,45,2);
INSERT INTO productos_pedidos VALUES (116,'21636',5,14,1);
INSERT INTO productos_pedidos VALUES (116,'AR-001',32,1,2);
INSERT INTO productos_pedidos VALUES (116,'AR-005',18,1,5);
INSERT INTO productos_pedidos VALUES (116,'FR-33',13,8,3);
INSERT INTO productos_pedidos VALUES (116,'OR-200',10,4,4);
INSERT INTO productos_pedidos VALUES (117,'FR-78',2,15,1);
INSERT INTO productos_pedidos VALUES (117,'FR-80',1,32,3);
INSERT INTO productos_pedidos VALUES (117,'OR-146',17,4,2);
INSERT INTO productos_pedidos VALUES (117,'OR-179',4,6,4);
INSERT INTO productos_pedidos VALUES (128,'AR-004',15,1,1);
INSERT INTO productos_pedidos VALUES (128,'OR-150',18,2,2);
INSERT INTO productos_pedidos VALUES (52,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (59,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (60,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (61,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (62,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (63,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (64,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (65,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (66,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (67,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (68,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (111,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (112,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (113,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (114,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (115,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (118,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (119,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (120,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (121,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (122,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (123,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (124,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (125,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (126,'FR-67',10,70,1);
INSERT INTO productos_pedidos VALUES (127,'FR-67',10,70,1);
